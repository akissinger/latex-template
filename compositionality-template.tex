\documentclass[a4paper,superscriptaddress,10pt,unpublished,shorttitle=template]{compositionalityarticle}
% \documentclass[a4paper,superscriptaddress,10pt,accepted=22-07-2018,issuemonth=July, issueyear=2018, shorttitle=template]{compositionalityarticle}
\pdfoutput=1
...
% Fix amsthm clobbering Compositionality fonts
\usepackage{amsthm}
\newtheoremstyle{definition}{8pt}{8pt}
{\merriweatherlight}{}
{\merriweatherlight\bfseries}
{.}{1em}{}

\makeatletter
\renewenvironment{proof}[1][\proofname]{\par
\pushQED{\qed}%
\merriweatherlight \topsep6\p@\@plus6\p@\relax
\trivlist
\item\relax
{\itshape
